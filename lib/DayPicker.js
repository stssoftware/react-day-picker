  ...
  _createClass(DayPicker, [{
    ...
    value: function renderNavbar() {
      var _props2 = this.props,
          ...
          navbarComponent = _props2.navbarComponent,
          navbarElement = _props2.navbarElement,
          attributes = _objectWithoutProperties(_props2, ['locale', 'localeUtils', 'canChangeMonth', 'navbarComponent', 'navbarElement']);
...
DayPicker.propTypes = {
  ...
  weekdayComponent: (0, _reactIsDeprecated.deprecate)(_propTypes2.default.func, 'react-day-picker: the `weekdayComponent` prop is deprecated from v2.3. Please pass a React element to the `weekdayElement` prop instead.'), // eslint-disable-line max-len
  weekdayElement: _propTypes2.default.element,
  navbarComponent: (0, _reactIsDeprecated.deprecate)(_propTypes2.default.func, 'react-day-picker: the `navbarComponent` prop is deprecated from v2.3. Please pass a React element to the `navbarElement` prop instead.'), // eslint-disable-line max-len
